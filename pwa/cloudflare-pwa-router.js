...
*/
const SOURCE_BASE="https://raw.githubusercontent.com/hadi89mok/ma7alak/main/pwa/";
...
export default {
  async fetch(request){
    ...
    const upstream=await fetch(
      ...
      {
        headers:{"User-Agent":"Ma7alak-PWA-Worker/1.1"},
    ...
    headers.set("Content-Type",CONTENT_TYPES[url.pathname]||"application/octet-stream");
    ...
    }else if(url.pathname.startsWith("/pwa-icon-")){
