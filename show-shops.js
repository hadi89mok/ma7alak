...
@keyframes m7d-in{from{opacity:0;transform:translateY(24px)}to{opacity:1;transform:none}}@keyframes m7d-pulse{50%{box-shadow:0 0 0 4px #42ff7330}}@keyframes m7d-featured-badge{0%,100%{transform:translateZ(0) scale(1);filter:brightness(1);box-shadow:0 0 10px #ff294b70,0 7px 17px #0009}50%{transform:translateZ(0) scale(1.045);filter:brightness(1.18);box-shadow:0 0 23px #ff294bd9,0 0 0 4px #ff405b24,0 7px 17px #0009}}@keyframes m7d-card-featured{0%,100%{box-shadow:0 10px 26px #0008,0 0 7px #ff28406b}50%{box-shadow:0 11px 29px #000a,0 0 23px #ff2840e8,0 0 0 2px #ff405b3d}}@keyframes m7d-card-accent{0%,100%{box-shadow:0 10px 26px #0008,0 0 5px color-mix(in srgb,var(--card-accent) 48%,transparent)}50%{box-shadow:0 11px 29px #000a,0 0 19px color-mix(in srgb,var(--card-accent) 82%,transparent),0 0 0 2px color-mix(in srgb,var(--card-accent) 25%,transparent)}}@keyframes m7d-story-spin{to{transform:rotate(360deg)}}@-webkit-keyframes m7d-story-spin{to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}
...
.m7d-og-core::after{content:"";position:absolute;inset:-35%;z-index:0;background:linear-gradient(105deg,transparent 38%,color-mix(in srgb,var(--m7d-og-secondary) 70%,transparent) 49%,transparent 60%);transform:translate3d(-70%,0,0) rotate(8deg);-webkit-transform:translate3d(-70%,0,0) rotate(8deg);will-change:transform,opacity;-webkit-backface-visibility:hidden;backface-visibility:hidden}
.m7d-og-badge[data-animation="shimmer"] .m7d-og-core::after{animation:m7dOgShimmer var(--m7d-og-speed) ease-in-out infinite!important;-webkit-animation:m7dOgShimmer var(--m7d-og-speed) ease-in-out infinite!important}
.m7d-og-badge[data-animation="breathe"] .m7d-og-core{animation:m7dOgBreathe var(--m7d-og-speed) ease-in-out infinite!important;-webkit-animation:m7dOgBreathe var(--m7d-og-speed) ease-in-out infinite!important}
.m7d-og-badge[data-animation="float"] .m7d-og-core{animation:m7dOgFloat var(--m7d-og-speed) ease-in-out infinite!important;-webkit-animation:m7dOgFloat var(--m7d-og-speed) ease-in-out infinite!important}
.m7d-og-badge[data-animation="pulse"] .m7d-og-core{animation:m7dOgPulse var(--m7d-og-speed) ease-in-out infinite!important;-webkit-animation:m7dOgPulse var(--m7d-og-speed) ease-in-out infinite!important}
.m7d-og-badge[data-animation="sparkle"] .m7d-og-core{animation:m7dOgSparkle var(--m7d-og-speed) ease-in-out infinite!important;-webkit-animation:m7dOgSparkle var(--m7d-og-speed) ease-in-out infinite!important}
@keyframes m7dOgShimmer{0%,28%{transform:translate3d(-70%,0,0) rotate(8deg);opacity:0}48%{opacity:1}72%,100%{transform:translate3d(70%,0,0) rotate(8deg);opacity:0}}
@-webkit-keyframes m7dOgShimmer{0%,28%{-webkit-transform:translate3d(-70%,0,0) rotate(8deg);opacity:0}48%{opacity:1}72%,100%{-webkit-transform:translate3d(70%,0,0) rotate(8deg);opacity:0}}
@keyframes m7dOgBreathe{0%,100%{transform:translateZ(0) scale(.97);opacity:.92;box-shadow:inset 0 0 0 1.5px color-mix(in srgb,var(--m7d-og-primary) 70%,transparent),0 0 calc(var(--m7d-og-glow) * .55) color-mix(in srgb,var(--m7d-og-primary) 48%,transparent)}50%{transform:translateZ(0) scale(1.045);opacity:1;box-shadow:inset 0 0 0 1.5px var(--m7d-og-primary),0 0 var(--m7d-og-glow) color-mix(in srgb,var(--m7d-og-primary) 80%,transparent)}}
@-webkit-keyframes m7dOgBreathe{0%,100%{-webkit-transform:translateZ(0) scale(.97);opacity:.92}50%{-webkit-transform:translateZ(0) scale(1.045);opacity:1}}
@keyframes m7dOgFloat{0%,100%{transform:translate3d(0,0,0) rotate(-2deg)}50%{transform:translate3d(0,-3px,0) rotate(2deg)}}
@-webkit-keyframes m7dOgFloat{0%,100%{-webkit-transform:translate3d(0,0,0) rotate(-2deg)}50%{-webkit-transform:translate3d(0,-3px,0) rotate(2deg)}}
@keyframes m7dOgPulse{0%,100%{transform:translateZ(0) scale(.96);opacity:.94}50%{transform:translateZ(0) scale(1.07);opacity:1}}
@-webkit-keyframes m7dOgPulse{0%,100%{-webkit-transform:translateZ(0) scale(.96);opacity:.94}50%{-webkit-transform:translateZ(0) scale(1.07);opacity:1}}
@keyframes m7dOgSparkle{0%,100%{transform:translateZ(0) scale(1);opacity:.9}25%{transform:translateZ(0) scale(1.055);opacity:1}50%{transform:translateZ(0) scale(.985);opacity:.94}75%{transform:translateZ(0) scale(1.04);opacity:1}}
@-webkit-keyframes m7dOgSparkle{0%,100%{-webkit-transform:translateZ(0) scale(1);opacity:.9}25%{-webkit-transform:translateZ(0) scale(1.055);opacity:1}50%{-webkit-transform:translateZ(0) scale(.985);opacity:.94}75%{-webkit-transform:translateZ(0) scale(1.04);opacity:1}}
...
@media(prefers-reduced-motion:reduce){
  /* Keep branded/availability motion deterministic across devices.
     Only neutralize smooth scrolling here; animation state is owned by the app. */
...
`;
  ...
  function places(){
    const p=state.areas
      ...
      .map(a=>({key:a.area_key,name:a.area_name,city:a.city_key,type:"area"}));
    state.cities
      .filter(c=>c.is_active!==false)
      .forEach(c=>{
        if(!p.some(a=>norm(a.key)===norm(c.city_key)))p.push({key:c.city_key,name:c.city_name,city:c.city_key,type:"city"});
      });
    return p;
  }
  function quickPlaces(){
    const all=places(),counts=new Map();
    state.shops.forEach(s=>{
      const areaName=norm(s.area),cityKey=norm(s.city);
      let match=null;
      if(areaName)match=all.find(p=>p.type==="area"&&(norm(p.name)===areaName||norm(p.key)===areaName));
      if(!match&&cityKey)match=all.find(p=>p.type==="city"&&norm(p.key)===cityKey);
      if(!match&&cityKey)match=all.find(p=>norm(p.key)===cityKey);
      if(match)counts.set(match.key,(counts.get(match.key)||0)+1);
    });
    return all
      .filter(p=>counts.has(p.key))
      .sort((a,b)=>(counts.get(b.key)-counts.get(a.key))||a.name.localeCompare(b.name))
      .slice(0,4);
  }
  function currentPlaceLabel(){
    if(coords)return "Near me";
    if(!area)return "Choose location";
    const p=places().find(x=>norm(x.key)===norm(area));
    return p?.name||area;
  }
  function locationOptions(){
    const cityRows=state.cities.filter(x=>x.is_active!==false);
    let html='<option value="">All Lebanon</option>';
    cityRows.forEach(city=>{
      const rows=state.areas.filter(a=>a.is_active!==false&&norm(a.city_key)===norm(city.city_key));
      html+='<optgroup label="'+esc(city.city_name)+'">';
      html+='<option value="'+esc(city.city_key)+'">All '+esc(city.city_name)+'</option>';
      rows.forEach(a=>{html+='<option value="'+esc(a.area_key)+'">'+esc(a.area_name)+'</option>'});
      html+='</optgroup>';
    });
    return html;
  }
  function areaButtons(){
    const quick=quickPlaces();
    return `<button class="m7d-pill" data-area="" aria-pressed="${!area&&!coords}">All Lebanon</button>`
      +quick.map(a=>`<button class="m7d-pill" data-area="${esc(a.key)}" aria-pressed="${norm(area)===norm(a.key)&&!coords}">${esc(a.name)}</button>`).join('')
      +`<button class="m7d-pill" data-action="near" aria-pressed="${!!coords}">${icon('near')}Near me</button>`
      +`<button class="m7d-pill m7d-location-more" data-action="areas">${icon('pin')}More locations</button>`;
  }
  ...
  function ogBadgeIcon(s){
    ...
    /* Directory badges share one fixed footprint so OG and Verified align. */
    const badgeSize=21;
  ...
  function renderCards(){const a=filtered(),filteredMode=!!(q||category||area||coords||followedOnly||liveOnly),highlightedShops=a.filter(s=>featured(s)||norm(s.directory_options?.badge)==='new'),popularShops=filteredMode?a:a.filter(s=>!highlightedShops.includes(s)),primaryShops=filteredMode?a:(popularShops.length?popularShops:a);root.querySelector('[data-categories]').innerHTML=categoryButtons();root.querySelector('[data-results-title]').textContent=filteredMode?'Explore shops':state.settings.shops_title;root.querySelector('[data-count]').textContent=primaryShops.length+' shop'+(primaryShops.length===1?'':'s')+(coords?' nearby':'')+' ›';const grid=root.querySelector('[data-grid]'),markup=primaryShops.slice(0,limit).map(card).join('')||emptyState();grid.classList.toggle('m7d-strip',!filteredMode);if(grid.dataset.signature!==markup){grid.innerHTML=markup;grid.dataset.signature=markup}const section=root.querySelector('[data-featured-section]'),featuredGrid=root.querySelector('[data-featured-grid]');section.querySelector('h2').innerHTML='Featured &amp; New';section.hidden=filteredMode||!highlightedShops.length;const featureMarkup=highlightedShops.map(card).join('');if(featuredGrid.dataset.signature!==featureMarkup){featuredGrid.innerHTML=featureMarkup;featuredGrid.dataset.signature=featureMarkup}root.querySelector('[data-featured-count]').textContent=highlightedShops.length+' highlighted ›';root.querySelector('[data-action=more]').hidden=!filteredMode||a.length<=limit;root.querySelector('[data-saved]').textContent=followedOnly?'Show all shops':'♡ Following ('+followed.size+')'}
  ...
  function showFilters(){
    shopOpen='';
    setPanel('Find your next local favorite',`
      <div class="m7d-location-picker">
        <label><span>Location</span><select data-location-select>${locationOptions()}</select></label>
        <button class="m7d-pill m7d-near-button" data-action="near">${icon('near')} Use my location</button>
        <small>Choose one place only. Areas are grouped under their city / region.</small>
      </div>
      <label>Sort by<select data-sort><option value="popular">Most popular</option><option value="name">Name A–Z</option></select></label>
      <label><input type="checkbox" data-live ${liveOnly?'checked':''}> Live offers now</label>
      <label><input type="checkbox" data-followed-only ${followedOnly?'checked':''}> Only shops I follow</label>
      <h3>Categories</h3><div class="m7d-categories">${categoryButtons()}</div>
      <p><button class="m7d-gold" data-action="apply">Show results</button> <button class="m7d-pill" data-action="reset">Reset filters</button></p>
    `);
    panel.querySelector('[data-sort]').value=sort;
    const locationSelect=panel.querySelector('[data-location-select]');
    if(locationSelect)locationSelect.value=coords?"":area;
  }
  ...
  function detailHead(s){return `${img(s.directory_options?.profile_banner_image_url,'m7d-detail-cover')}<div class="m7d-detail-head">${img(s.profile_image_url)}<div><h3>${esc(s.shop_name)}</h3><p>${esc(s.category_name||'Local shop')} · ${esc(s.location||'Location coming soon')}</p></div></div>`}
