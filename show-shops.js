...
(function(){
  ...
  */
  ...
  const defaults={title:'شوف المحلات',subtitle:'Discover what’s around you',hero:new URL('assets/directory-beirut-night.webp',assetBase).href,logo:'https://6aa2c9b0ea08b9137fd5ada9.imgix.net/sandbox/Gemini_Generated_Image_ds8wfsds8wfsds8w.jfif',search:'Search shops, food, services...',location_title:'Where are you looking?',categories_title:'Browse categories',shops_title:'Popular near you',cta_title:'Own a local business?',cta_text:'Add your shop and reach more people.',cta_button:'Add your shop',show_cta:true,show_categories:true,category_order:['cafe','food','beauty','clothing','services'],category_labels:{cafe:'Cafés',food:'Food',beauty:'Beauty',clothing:'Fashion',services:'Services'},category_icons:{},radius:25};
