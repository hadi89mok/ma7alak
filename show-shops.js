...
@keyframes m7dLogoFloat{0%,100%{transform:translate3d(0,0,0)}50%{transform:translate3d(0,-7px,0)}}
@media(prefers-reduced-motion:reduce){.m7d-logo{animation:none!important;transform:none!important;will-change:auto}}.m7d-hero h1{font-size:30px;line-height:1.2;color:#efce86;margin:0;font-weight:700}.m7d-hero p{font-size:15px;color:#c4c1b9;margin:3px 0 0;letter-spacing:.3px}.m7d-side{position:absolute;right:14px;top:15px;color:#d1bc8b;font:italic 13px/1.05 Georgia,serif;transform:rotate(-8deg)}
