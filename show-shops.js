...
(function(){
  ...
  /* =========================================================
     INSERT PAGE — TOP PRIORITY
     ---------------------------------------------------------
     IMPORTANT:
     Hostinger can wrap its header/nav inside a large section.
     Inserting "afterend" of the first nav/header can therefore
     place the directory halfway down the page.

     This version inserts the Ma7alak directory at the top-level
     of <body>. If a REAL direct-child header exists, it is placed
     immediately after that header. Otherwise it becomes the first
     body element.
  ========================================================= */
  ...
  function insertPage(){
    ...
    for(
      const selector of directHeaderSelectors
    ){
    ...
    if(directHeader){
      ...
      directHeader.insertAdjacentElement(
        "afterend",
        page
      );
    ...
    /*
       Keep the directory as the first real content layer even if
       Hostinger injects wrappers/backgrounds after our script runs.
    */
    page.style.position =
      "relative";
...
/* =========================================================
   MA7ALAK — HOSTINGER TOP POSITION WATCH
   ---------------------------------------------------------
   If Hostinger injects/reorders sections after page load,
   keep #ma7alak-shops-page at the top of body (or directly
   after a direct-child header).
========================================================= */
...
(function(){
  ...
  function keepDirectoryAtTop(){
      ...
      Array.from(
        ...
        function(element){
          ...
          return (
            ...
            element.classList.contains("website-header")
          );
    ...
    if(directHeader){
      ...
      if(
        directHeader.nextElementSibling !== page
      ){
      ...
      document.body.firstElementChild !== page
    ){
