...
.m7hf-social.m7hf-social-whatsapp{position:relative;top:-6px;border:0!important;background:transparent!important;box-shadow:none!important}
.m7hf-social.m7hf-social-whatsapp svg{width:90%;height:90%;filter:drop-shadow(0 0 5px rgba(37,211,102,.30)) drop-shadow(0 2px 3px rgba(0,0,0,.20))}
.m7hf-social.m7hf-social-whatsapp img{width:88%;height:88%;filter:drop-shadow(0 0 5px rgba(37,211,102,.28)) drop-shadow(0 2px 3px rgba(0,0,0,.20))}
.m7hf-rule{width:min(470px,86%);height:1px;margin:0 auto 17px;background:linear-gradient(90deg,transparent 4%,color-mix(in srgb,var(--m7hf-accent2) 78%,transparent),transparent 96%);box-shadow:0 0 7px color-mix(in srgb,var(--m7hf-accent) 18%,transparent)}
...
@media(max-width:700px){
  ...
  .m7hf-nav{gap:4px 8px!important;margin:0 0 7px!important}
  .m7hf-nav a{min-height:27px!important;font-size:11px!important;padding:3px 2px!important}
  .m7hf-socials{gap:8px!important;margin-bottom:6px!important}
  ...
  .m7hf-social.m7hf-social-whatsapp{width:min(calc(var(--m7hf-social-size,46px) * 1.18),50px,14vw)!important;height:min(calc(var(--m7hf-social-size,46px) * 1.18),50px,14vw)!important;top:-6px!important}
  .m7hf-rule{margin-top:-1px!important;margin-bottom:8px!important}
