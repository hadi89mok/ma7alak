...
#ma7alak-live-stats .ma7alak-live-item{
  ...
  gap:3px;padding:1px 2px;box-sizing:border-box;
}
...
#ma7alak-live-stats .ma7alak-live-number{
  font-size:14px;font-weight:800;line-height:1;color:#fff;letter-spacing:0;
  text-shadow:0 1px 2px rgba(0,0,0,.34);
}
#ma7alak-live-stats .ma7alak-live-label{
  margin-top:2px;font-size:7px;font-weight:650;line-height:1.15;
...
@media(max-width:500px){
  #ma7alak-live-stats{max-width:275px;width:calc(100% - 96px)!important;padding:0!important}
  #ma7alak-live-stats .ma7alak-live-panel{padding:5px 4px;border-radius:10px;backdrop-filter:none;-webkit-backdrop-filter:none}
  #ma7alak-live-stats .ma7alak-live-item{gap:2px;padding:1px 1px}
  #ma7alak-live-stats .ma7alak-live-icon{font-size:11px}
  #ma7alak-live-stats .ma7alak-live-number{font-size:13px}
  #ma7alak-live-stats .ma7alak-live-label{font-size:6.5px;font-weight:650}
  #ma7alak-live-stats .ma7alak-live-divider{height:19px}
}
