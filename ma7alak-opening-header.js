...
/* =========================================================
   ...
   Opening Header + Happening Today + Reels + Local Spotlight
   The homepage feed is bundled here so Hostinger needs no separate home-feed loader.
...
\n`; document.head.appendChild(style);
 ...
 function place(){
   ...
   if(block&&hero){
     /* Permanent order: Opening Header -> separator -> Live/Reels/Spotlight.
