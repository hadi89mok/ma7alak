...
(function(){
  ...
  function inject(){
    ...
    style.textContent=
      "#ma7alak-exact-merged-hub{position:relative!important;overflow:visible!important}#ma7alak-exact-merged-hub:has(#m7-owner-about-edit.visible){padding-top:20px!important}"+
      "#m7-owner-about-edit{position:absolute!important;top:7px!important;right:24px!important;left:auto!important;z-index:180!important;width:auto!important;height:27px!important;min-width:58px!important;min-height:27px!important;margin:0!important;padding:0 13px!important;border:1px solid rgba(var(--m7-shop-accent-rgb,217,164,65),.52)!important;border-radius:999px!important;background:linear-gradient(180deg,var(--m7-about-edit-bg,#11100e),#060607)!important;color:var(--m7-shop-accent-light,#f0cc83)!important;font:950 8px/1 Arial,Segoe UI,sans-serif!important;letter-spacing:1.25px!important;display:none!important;align-items:center!important;justify-content:center!important;box-shadow:0 6px 18px rgba(0,0,0,.36),inset 0 1px 0 rgba(255,255,255,.06)!important;backdrop-filter:blur(10px)!important;-webkit-backdrop-filter:blur(10px)!important;-webkit-tap-highlight-color:transparent!important;touch-action:manipulation!important;outline:none!important}"+
      "#m7-owner-about-edit.visible{display:flex!important}#m7-owner-about-edit:active{transform:translateY(1px) scale(.97)!important}"+
      ...
      "@media(max-width:480px){#ma7alak-exact-merged-hub:has(#m7-owner-about-edit.visible){padding-top:20px!important}#m7-owner-about-edit{top:7px!important;right:22px!important;height:27px!important;min-width:56px!important;min-height:27px!important;padding:0 12px!important;font-size:7.7px!important}#m7-owner-about-sheet{inset:5px!important;padding:12px!important;border-radius:18px!important}#m7-owner-about-textarea{min-height:210px!important;font-size:14px!important}}";
    document.head.appendChild(style);
    ...
    sheet.querySelector("#m7-owner-about-close").addEventListener("click",function(){
