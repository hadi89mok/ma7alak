...
if(!mount){
  console.error("[Ma7alak Hub] Mount element not found.");
  return;
}
...
(function(){
  ...
  */
  /*
     ...
     Do NOT overwrite Ma7alak's normal shared Supabase client because
...
(function(){
  ...
  async function loadAbout(){
    ...
    try{
      ...
      if(!result.data){
        console.warn(
          "MA7ALAK About: no shop found for slug:",
          SHOP_SLUG
        );
        return;
      }
...
(function(){
  ...
  async function loadSocialPanel(){
    ...
    if(!result.data){
      console.warn(
        "MA7ALAK social: no Admin shop found for",
        SHOP_SLUG
      );
      return;
    }
  ...
  async function loadLocationPanel(){
    ...
    const result =
      await client
        .from("shop_profiles")
        .select(
          "shop_slug,location,directory_options"
        )
        .eq("shop_slug",SHOP_SLUG)
        .maybeSingle();
    ...
    if(!result.data){
      console.warn(
        "MA7ALAK location: no Admin shop found for",
        SHOP_SLUG
      );
      return;
    }
...
(function(){
  ...
  async function loadExtraProfile(){
    ...
    try{
      ...
      console.warn(
        "[Ma7alak Exact Hub] optional map:",
        error
      );
...
(function(){
  ...
  start().catch(error=>
    console.warn("[Ma7alak Hub] Design Studio:",error)
  );
...
/* =========================================================
   MA7ALAK PROFILE HUB — SOCIAL PROFILE ADDON LOADER
========================================================= */
(function(){
  "use strict";

  if(window.__MA7ALAK_SOCIAL_PROFILE_LOADER__){
    return;
  }

  window.__MA7ALAK_SOCIAL_PROFILE_LOADER__ = true;
...
/* =========================================================
   MA7ALAK PROFILE HUB — PAGE DESIGN STUDIO V2 ADDON LOADER
========================================================= */
(function(){
  "use strict";
