...
/* =========================================================
   MA7ALAK ADMIN — SHOP / ABOUT TITLE STYLE CONTROLS
   Safe additive layer. Stores values in directory_options.
========================================================= */
(function(){
  "use strict";
  ...
  if(
    ...
    window.__MA7ALAK_ADMIN_TITLE_STYLE_CONTROLS__
  ){
    return;
  }
  ...
  function mount(form,prefix){
    if(!form || form.querySelector(".m7-title-style-box")){
      return;
    }
    ...
    box.innerHTML = `
      ...
      <p>
        Control the large shop name on the owner page and the
        "About Shop" title separately. These settings update live.
      </p>
      ...
      <div class="m7-title-style-preview">
    ...
    const directoryBox =
      form.querySelector(
        ".m7da-fields:not(.m7da-home-fields):not(.m7labelbox)"
      );

    if(labelBox){
      labelBox.after(box);
    }
    else if(directoryBox){
      form.insertBefore(box,directoryBox);
    }
    else{
    ...
    const shopColor =
      box.querySelector("#"+prefix+"shop_name_color");

    const aboutColor =
      box.querySelector("#"+prefix+"about_title_color");

    const shopAnim =
      box.querySelector("#"+prefix+"shop_name_animation");

    const aboutAnim =
      box.querySelector("#"+prefix+"about_title_animation");

    const shopPreview =
      box.querySelector("[data-shop-preview]");

    const aboutPreview =
      box.querySelector("[data-about-preview]");

    function applyPreview(el,color,mode){
    ...
    [shopColor,aboutColor,shopAnim,aboutAnim]
      .forEach(input=>{
        input.addEventListener("input",preview);
        input.addEventListener("change",preview);
      });

    box.__m7TitlePreview = preview;
    preview();
  }
  ...
  function css(){
    if(document.getElementById("m7-title-style-admin-css")){
      return;
    }
    ...
    style.textContent = `
      .m7-title-style-box{
        ...
        background:
          radial-gradient(circle at 14% 0%,rgba(242,202,237,.07),transparent 35%),
          rgba(18,14,12,.88)!important;
      }

      .m7-title-style-preview{
        display:grid;
      ...
      .m7-title-style-preview span{
        min-height:42px;
        display:grid;
        place-items:center;
        padding:7px 9px;
        border-radius:12px;
        border:1px solid rgba(242,202,237,.15);
