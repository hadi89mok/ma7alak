...
#ma7alak-following-badge.visible{display:flex;animation:ma7alakFollowingBadgePop .28s cubic-bezier(.2,.9,.25,1.2);}
...
.ma7alak-following-avatar-ring{width:54px;height:54px;flex:0 0 54px;padding:2px;border-radius:50%;background:conic-gradient(from 20deg,#7f561a,#efc66e,#6c4513,#f5d88d,#7f561a);box-shadow:0 0 0 1px rgba(217,164,65,.15),0 0 18px rgba(217,164,65,.08)}
        ...
        <section id="ma7alak-following-panel" role="dialog" aria-modal="true" aria-labelledby="ma7alak-following-title">
          <div class="ma7alak-following-head">
            <div class="ma7alak-following-head-copy">
              ...
              <div class="ma7alak-following-subtitle">Shops you're following</div>
            </div>
...
"use strict";
  ...
  function updateFollowingBadge(){
    ...
    if(!badge){return;}
    const count=followedShopSlugs.length;
  ...
  function renderFollowingPanel(){
    ...
    list.innerHTML=profiles.map(function(shop){
      ...
      return `
        <a class="ma7alak-following-row" href="/${encodeURIComponent(slug)}" aria-label="Open ${escapeHTML(name)}">
