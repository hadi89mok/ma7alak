...
function style(){
  ...
  s.id="m7-msg-int-css";
  s.textContent=`#m7-viewer-account-btn,#m7-header-messages,#m7-owner-messages{position:relative}.m7-msg-badge{position:absolute;top:2px;right:2px;min-width:16px;height:16px;padding:0 3px;display:none;align-items:center;justify-content:center;border:2px solid #0b0c0d;border-radius:999px;background:#e08b22;color:#fff;font:900 8px/1 Arial;z-index:8;pointer-events:none;box-shadow:0 2px 8px #0006}.m7-msg-badge.visible{display:flex}.m7-hidden{display:none!important}#m7-header-messages .ma7alak-header-nav-icon,#m7-owner-messages .ma7alak-header-nav-icon{width:22px!important;height:22px!important}#m7-header-messages .ma7alak-header-nav-icon svg,#m7-owner-messages .ma7alak-header-nav-icon svg{width:22px!important;height:22px!important;stroke-width:1.75!important}@media(max-width:900px){#ma7alak-social-header{padding-left:4px!important}#ma7alak-social-header .ma7alak-header-brand{margin-left:0!important;padding-left:0!important}#m7-viewer-account-btn,#m7-header-messages,#m7-owner-messages{min-width:39px!important;width:39px!important;height:44px!important}}@media(max-width:390px){#m7-viewer-account-btn,#m7-header-messages,#m7-owner-messages{min-width:36px!important;width:36px!important}}`;
