  ...
  */
  ...
  function installCss(){
    ...
    style.textContent=`
      ...
      .m7og-core::after{content:""!important;position:absolute!important;inset:-38%!important;z-index:0!important;background:linear-gradient(105deg,transparent 38%,color-mix(in srgb,var(--m7og-secondary) 72%,transparent) 49%,transparent 60%)!important;transform:translate3d(-72%,0,0) rotate(8deg);-webkit-transform:translate3d(-72%,0,0) rotate(8deg);will-change:transform,opacity!important;-webkit-backface-visibility:hidden;backface-visibility:hidden}
      .m7og-badge[data-animation="shimmer"] .m7og-core::after{animation:m7og-shimmer var(--m7og-speed) ease-in-out infinite!important;-webkit-animation:m7og-shimmer var(--m7og-speed) ease-in-out infinite!important}
      .m7og-badge[data-animation="breathe"] .m7og-core{animation:m7og-breathe var(--m7og-speed) ease-in-out infinite!important;-webkit-animation:m7og-breathe var(--m7og-speed) ease-in-out infinite!important}
      .m7og-badge[data-animation="float"] .m7og-core{animation:m7og-float var(--m7og-speed) ease-in-out infinite!important;-webkit-animation:m7og-float var(--m7og-speed) ease-in-out infinite!important}
      .m7og-badge[data-animation="pulse"] .m7og-core{animation:m7og-pulse var(--m7og-speed) ease-in-out infinite!important;-webkit-animation:m7og-pulse var(--m7og-speed) ease-in-out infinite!important}
      .m7og-badge[data-animation="sparkle"] .m7og-core{animation:m7og-sparkle var(--m7og-speed) ease-in-out infinite!important;-webkit-animation:m7og-sparkle var(--m7og-speed) ease-in-out infinite!important}
      ...
      #ma7alak-story-wrapper.m7story-managed #ma7alak-story-button{border-radius:50%!important;background:transparent!important;animation:none!important;-webkit-animation:none!important}
      #ma7alak-story-wrapper.m7story-managed #ma7alak-story-button::before,#ma7alak-story-wrapper.m7story-managed #ma7alak-story-button::after{content:none!important;display:none!important;animation:none!important;-webkit-animation:none!important}
      #ma7alak-story-wrapper.m7story-managed #ma7alak-story-preview img{animation:none!important;-webkit-animation:none!important}
      #ma7alak-story-wrapper.m7story-managed #ma7alak-story-active-ring,#ma7alak-story-wrapper.m7story-managed #ma7alak-story-new-ring{display:none!important;animation:none!important;-webkit-animation:none!important}
      ...
      @keyframes m7story-spin{to{transform:rotate(360deg)}}
      @-webkit-keyframes m7story-spin{to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}
      @keyframes m7story-glow{0%,100%{opacity:.58;transform:translateZ(0) scale(.985);box-shadow:0 0 calc(var(--m7story-glow) * .62) var(--m7story-color)}50%{opacity:1;transform:translateZ(0) scale(1.04);box-shadow:0 0 var(--m7story-glow) var(--m7story-color)}}
      @-webkit-keyframes m7story-glow{0%,100%{opacity:.58;-webkit-transform:translateZ(0) scale(.985)}50%{opacity:1;-webkit-transform:translateZ(0) scale(1.04)}}
      @keyframes m7story-heartbeat{10%,30%{transform:translateZ(0) scale(1.065)}20%,40%,100%{transform:translateZ(0) scale(1)}}
      @-webkit-keyframes m7story-heartbeat{10%,30%{-webkit-transform:translateZ(0) scale(1.065)}20%,40%,100%{-webkit-transform:translateZ(0) scale(1)}}
      @keyframes m7story-radar{0%{opacity:.72;transform:translateZ(0) scale(.94)}100%{opacity:0;transform:translateZ(0) scale(1.32)}}
      @-webkit-keyframes m7story-radar{0%{opacity:.72;-webkit-transform:translateZ(0) scale(.94)}100%{opacity:0;-webkit-transform:translateZ(0) scale(1.32)}}
      @keyframes m7story-halo{0%,100%{opacity:.68;box-shadow:0 0 calc(var(--m7story-glow) * .55) var(--m7story-color)}50%{opacity:1;box-shadow:0 0 var(--m7story-glow) var(--m7story-color),0 0 calc(var(--m7story-glow) * 1.7) var(--m7story-color)}}
      @-webkit-keyframes m7story-halo{0%,100%{opacity:.68}50%{opacity:1}}
      @keyframes m7story-neon{0%,100%{opacity:.74;transform:translateZ(0) scale(.99)}50%{opacity:1;transform:translateZ(0) scale(1.025)}}
      @-webkit-keyframes m7story-neon{0%,100%{opacity:.74;-webkit-transform:translateZ(0) scale(.99)}50%{opacity:1;-webkit-transform:translateZ(0) scale(1.025)}}
      @keyframes m7story-logo{0%,100%{transform:translateZ(0) scale(1);opacity:1}50%{transform:translateZ(0) scale(1.018);opacity:.94}}
      @-webkit-keyframes m7story-logo{0%,100%{-webkit-transform:translateZ(0) scale(1);opacity:1}50%{-webkit-transform:translateZ(0) scale(1.018);opacity:.94}}
      @keyframes m7story-burst{0%{opacity:.95;transform:translateZ(0) scale(.72)}100%{opacity:0;transform:translateZ(0) scale(1.48)}}
      @-webkit-keyframes m7story-burst{0%{opacity:.95;-webkit-transform:translateZ(0) scale(.72)}100%{opacity:0;-webkit-transform:translateZ(0) scale(1.48)}}
      @keyframes m7story-particle{0%{opacity:1;transform:translate(-50%,-50%) rotate(var(--m7story-angle)) translateX(9px) scale(.7)}100%{opacity:0;transform:translate(-50%,-50%) rotate(var(--m7story-angle)) translateX(var(--m7story-distance)) scale(1.15)}}
      @-webkit-keyframes m7story-particle{0%{opacity:1;-webkit-transform:translate(-50%,-50%) rotate(var(--m7story-angle)) translateX(9px) scale(.7)}100%{opacity:0;-webkit-transform:translate(-50%,-50%) rotate(var(--m7story-angle)) translateX(var(--m7story-distance)) scale(1.15)}}
      @keyframes m7og-shimmer{0%,28%{transform:translate3d(-72%,0,0) rotate(8deg);opacity:0}48%{opacity:1}72%,100%{transform:translate3d(72%,0,0) rotate(8deg);opacity:0}}
      @-webkit-keyframes m7og-shimmer{0%,28%{-webkit-transform:translate3d(-72%,0,0) rotate(8deg);opacity:0}48%{opacity:1}72%,100%{-webkit-transform:translate3d(72%,0,0) rotate(8deg);opacity:0}}
      @keyframes m7og-breathe{0%,100%{transform:translateZ(0) scale(.97);opacity:.92;box-shadow:inset 0 0 0 2px color-mix(in srgb,var(--m7og-primary) 70%,transparent),0 0 calc(var(--m7og-glow) * .55) color-mix(in srgb,var(--m7og-primary) 50%,transparent)}50%{transform:translateZ(0) scale(1.045);opacity:1;box-shadow:inset 0 0 0 2px var(--m7og-primary),0 0 var(--m7og-glow) color-mix(in srgb,var(--m7og-primary) 82%,transparent)}}
      @-webkit-keyframes m7og-breathe{0%,100%{-webkit-transform:translateZ(0) scale(.97);opacity:.92}50%{-webkit-transform:translateZ(0) scale(1.045);opacity:1}}
      @keyframes m7og-float{0%,100%{transform:translate3d(0,0,0) rotate(-2deg)}50%{transform:translate3d(0,-4px,0) rotate(2deg)}}
      @-webkit-keyframes m7og-float{0%,100%{-webkit-transform:translate3d(0,0,0) rotate(-2deg)}50%{-webkit-transform:translate3d(0,-4px,0) rotate(2deg)}}
      @keyframes m7og-pulse{0%,100%{transform:translateZ(0) scale(.96);opacity:.94}50%{transform:translateZ(0) scale(1.08);opacity:1}}
      @-webkit-keyframes m7og-pulse{0%,100%{-webkit-transform:translateZ(0) scale(.96);opacity:.94}50%{-webkit-transform:translateZ(0) scale(1.08);opacity:1}}
      @keyframes m7og-sparkle{0%,100%{transform:translateZ(0) scale(1);opacity:.9}25%{transform:translateZ(0) scale(1.055);opacity:1}50%{transform:translateZ(0) scale(.985);opacity:.94}75%{transform:translateZ(0) scale(1.04);opacity:1}}
      @-webkit-keyframes m7og-sparkle{0%,100%{-webkit-transform:translateZ(0) scale(1);opacity:.9}25%{-webkit-transform:translateZ(0) scale(1.055);opacity:1}50%{-webkit-transform:translateZ(0) scale(.985);opacity:.94}75%{-webkit-transform:translateZ(0) scale(1.04);opacity:1}}
      ...
      /* Device/OS reduced-motion does not silently change branded effects.
         data-motion-mode and page visibility are the single motion authority. */
    `;
  ...
  function applyStoryEffects(){
    ...
    const baseSpeed=clamp(options.story_new_speed,1,6,2.2);
    const motionMode=String(shell?.dataset?.motionMode||"full").toLowerCase();
    const speed=motionMode==="reduced"?Math.min(10,baseSpeed*1.65):baseSpeed;
  ...
  function renderOgBadge(){
    ...
    const ogBaseSpeed=clamp(options.og_badge_animation_speed,1,8,2.8);
    const ogMotionMode=String(shell?.dataset?.motionMode||"full").toLowerCase();
    ogLayer.style.setProperty("--m7og-speed",(ogMotionMode==="reduced"?Math.min(12,ogBaseSpeed*1.6):ogBaseSpeed)+"s");
